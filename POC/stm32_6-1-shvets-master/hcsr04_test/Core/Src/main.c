...
#define NO_RESULT_TIME 38000
#define SystemCoreClockInMHz 96
#define OVERFLOW_VALUE 10000
#define REFRESH_DELAY 500000
#define TRIGGER_TIME 10 // 16 us
#define CONVERT_FROM_USECONDS_TO_DISTANCE_CM 58
